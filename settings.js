...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=PmBBFQxK#hhmmK_ngOrQF5ONIDQ7hvE5NGJ1I9rk7tKsO5uCHb-8' : process.env.SESSION_ID,
...
NEWS_JID: process.env.NEWS_JID === undefined ? "94788231166@s.whatsapp.net" : process.env.NEWS_JID,
SEEDER_GMAIL: process.env.SEEDER_GMAIL === undefined ? "lalnishshanka3@gmail.com" : process.env.SEEDER_GMAIL,
SEEDER_PASSWORD: process.env.SEEDER_PASSWORD === undefined ? "lalnishshanka3@gmail.com" : process.env.SEEDER_PASSWORD,
